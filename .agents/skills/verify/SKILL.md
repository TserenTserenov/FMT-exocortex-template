...
- Уровень рассуждений субагента: средний
...
- Уровень рассуждений субагента: высокий
...
- **Этап 🟡 (два специализированных sub-agent, Opus, context isolation) — WP-322 Ф14:**
  ...
  **Sub-agent 1 — verify-fpf (промпт: `verify-fpf-subsection.md`):**
  ...
  - Промпт: `.agents/skills/verify/verify-fpf-subsection.md`
  ...
  **Sub-agent 2 — verify-pedagogy (промпт: `verify-pedagogy-subsection.md`):**
  - Вход: файл подраздела
  - Промпт: `.agents/skills/verify/verify-pedagogy-subsection.md`
  - Уровень рассуждений: высокий
...
- **Этап 🟡 (sub-agent, Opus, context isolation):**
  ...
  - **Уровень рассуждений: высокий** — по эталону `CHECKLIST-section-v1.md` §🟡 («агент с высоким уровнем рассуждений, context isolation»). Sonnet справляется по объёму, но связность нарратива и согласованность метафор раздела требуют глубокого анализа — Opus.
...
- **Этап 🟡 (sub-agent, Opus, context isolation):**
  ...
  - Уровень рассуждений: высокий (объём + глубина анализа мировоззренческого сдвига)
