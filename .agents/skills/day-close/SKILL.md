...
Day Close = протокол. Исполнять ТОЛЬКО пошагово через update_plan.
...
### 11. Верификация (лёгкий субагент R23)
Лёгкий субагент R23 (context isolation): передать чеклист + черновик итогов + список обновлённых файлов. По ❌ — исправить до показа пользователю.
