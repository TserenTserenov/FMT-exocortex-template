...
Week Close = протокол. Исполнять ТОЛЬКО пошагово через update_plan.
...
### 12. Верификация (лёгкий субагент R23)

Запустить лёгкий субагент в роли R23 Верификатор (context isolation).
