...
- **Развитие ≠ Образование.** Внешне (позиционирование, README, онбординг, посты) не использовать: «школа», «вуз», «студент», «преподаватель», «ученик», «образовательная платформа» и рамку «сначала учим — потом работаем». Внутри домена «ученик», «курс» и «занятие» легитимны как роли, ступени мастерства и curriculum-механика, но не выносятся наружу.
