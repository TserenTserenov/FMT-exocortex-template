...
- **Не делает:** не ведёт долгосрочную траекторию (Портной R28-catalog), не работает с мировоззрением (Навигатор R27), не пишет новый Pack.
...
| **Пересечение** | оргизменение требует нового Pack → создание Pack в целевом репозитории | применение метода требует обновления personal-guide → fix через Портного |
