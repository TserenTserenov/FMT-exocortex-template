...
After adding IWE, Claude will prompt you to sign in — log in with your system-school.ru account.
...
The AI assistant will load the IWE context and guide you from there: it will offer to answer a question, run a level diagnostic, or generate a development roadmap.
...
| **Personal knowledge base** | Save notes, ideas, and strategy — the AI will offer to create this in your first conversation |
...
The first 30 days of MIM knowledge are free. The price is locked in permanently with auto-renewal (it will be ~$40/month later).

Knowledge subscription: [system-school.ru/open-endedness](https://system-school.ru/open-endedness)

## Why This Matters (Short Version)

Bare ChatGPT or Claude is like a smart new hire on their first day. They know a lot, but they do not know *you*. IWE turns the AI into a personal assistant:
...
IWE works in clients beyond Claude.ai:
...
| Authorization error | Verify that you have an account on system-school.ru |
| Claude does not use IWE tools | Open a new chat. Write: "Use IWE — find documents about systems thinking" |
| "Not found in knowledge base" | Check that the Integration is active: Settings → Integrations → IWE → Connected |
