...
> Задумался, что будет с твоими настройками при обновлении IWE? → [Три слоя IWE](architecture-layers.md) — короткое объяснение, что обновляется автоматически, а что остаётся твоим навсегда.
...
| Тип | Что это | Примеры |
|-----|---------|---------|
| **Протоколы** | Формализованные последовательности (делаешь по шагам) | ОРЗ, Day Open/Close |
...
|-----|---------|---------|-----------------|
| **Протоколы** | Делаешь по шагам (формализовано) | ОРЗ, Day Open/Close | Следуешь инструкции → автоматизм |
