...
> Auto-generated by `scripts/generate-catalogs.py` · 2026-07-18 · DO NOT edit manually.
...
| `archive-done-wp.sh` | `scripts/archive-done-wp.sh` | atomic archival of a completed Work Product |
...
| `skills-pull.sh` | `scripts/skills-pull.sh` | sync L1 skills from FMT into the personal IWE |
