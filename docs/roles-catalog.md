...
> Автогенерировано `scripts/generate-catalogs.py` · 2026-08-11 · НЕ редактировать вручную.
...
| R3 | **Консультант** | Q&A участника, проверка ДЗ, генерация контента ленты/марафона |
