...
**Шаг 3.** Определить файлы/репо. Context file (`<governance-repo>/inbox/WP-{N}*.md`, например {{GOVERNANCE_REPO}}) — прочитать. Иерархия доверия: код → документы → WP context.

**Шаг 4.** Регистрация в `<governance-repo>/inbox/open-sessions.log` (например {{GOVERNANCE_REPO}}): `YYYY-MM-DD HH:MM | WP-N | модель | описание`. Исключения — не регистрировать.
