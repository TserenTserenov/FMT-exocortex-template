...
> **ПРАВИЛО (2026-02-13):** Не предлагай тактические заплатки без оценки последствий. Фикс слаб по эволюционируемости или связности — ищи правильное решение.
...
> **Урок (2026-02-15):** Предложил `submitted: common.mode_select` (грубый хак) вместо silent return (существующий паттерн). Причина: не посмотрел на эволюционируемость и на то, как задача решается сейчас. **Правило: оценка последствий — в первый ответ, не после запроса критики.**
